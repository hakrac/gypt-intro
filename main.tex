...
\begin{center}
{\large Fordert \color{orange} selbstständiges \color{blue}wissenschaftliches \color{black} Arbeiten an physikalischen Phänomenen, sowohl \underline{theoretisch} als auch \underline{experimentell}, von Schülern}
\end{center}
\pause
\vfill
...
\begin{frame}{Beispiel: \emph{Friction Oscillator}}
  ...
  \begin{tikzpicture}
    ...
    % Labels
        ...
        \node[black, fill=white] at (4, 9) {Spannungsqülle};
