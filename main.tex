...
\usetikzlibrary{angles, quotes, decorations.pathreplacing,calligraphy,calc}
...
\node[draw, inner sep=10pt, text width=2cm, align=center, right, fill=blue!20!white, minimum height=1.3cm] (5) at (5, -2) {Präsentation};
...
\node[right] at (5, -4.5) {\small Diskussion};
...
\node[draw, inner sep=10pt, text width=2cm, align=center, right, fill=white, minimum height=1.3cm] (5) at (5, -2) {Präsentation};
...
\begin{equation*}
x(t) = A sin(\omega_s t + \varphi)
\end{equation*}
\end{columns}
\vfill
\pause
Wenn $x(0) = x_0$ und $\dot{x}(0) = \dot{x}_0$ dann gilt,
\vfill
\begin{columns}
\column{0.5\textwidth}
\begin{equation*}
\varphi = arctan(\frac{x_0 \omega_s}{\dot{x}_0})
\end{equation*}
...
\node[draw, inner sep=10pt, text width=2cm, align=center, right, fill=green!20!white, minimum height=1.3cm] (5) at (5, -2) {Präsentation};
...
\begin{frame}{03 Siren}
\textbf{Phänomen} If you direct an air flow onto a rotating disk with holes, a sound may be heard.
\vfill
\begin{center}
\begin{tikzpicture}
\draw[fill=blue!20!white] (0, 0) circle[radius=2];
\foreach \p in {0, 1, ..., 12}
  \draw[fill=white] ({\p * 30}:1.6) circle[radius=0.2];

\filldraw[black] (0, 0) circle[radius=0.1];

\draw[thick, red, ->] (0, 0)+(2.3, 0) arc (0:45:2.3);
\draw[->, green!50!black, very thick] (0, 0.5) -- (30:1.6);
\end{tikzpicture}
\end{center}
\par
\vfill
...
\textbf{Aufgabe} Explain this phenomenon and investigate how the \color{blue}sound characteristics \color{black} depend on the \color{orange}relevant parameters\color{black}.
\end{frame}

\begin{frame}{06 Magnetic-Mechanical Oscillator}
\textbf{Phänomen} Secure the lower ends of two identical leaf springs to a non-magnetic base and attach magnets to the upper ends such that they repel and are free to move.
\vfill
\begin{center}
\begin{tikzpicture}
\draw[fill=black] (0, 0) -- (0, -4) -- (0.1, -4) -- (0.1, 0) -- (0, 0);
\draw[fill=red!20!white] (0.1, 0) -- (0.1, -1) -- (0.2, -1) -- (0.2, 0) -- (0.1, 0);
\draw[fill=green!20!white] (0.2, 0) -- (0.2, -1) -- (0.3, -1) -- (0.3, 0) -- (0.2, 0);
\draw[fill=red!20!white] (4, 0) -- (4, -1) -- (3.9, -1) -- (3.9, 0) -- (4, 0);
\draw[fill=green!20!white] (3.9, 0) -- (3.9, -1) -- (3.8, -1) -- (3.8, 0) -- (3.9, 0);
\draw[fill=black] (4, 0) -- (4, -4) -- (4.1, -4) -- (4.1, 0) -- (4, 0);
\draw[fill=brown!50!black] (-0.5, -4) -- (4.5, -4) -- (4.5, -4.2) -- (-0.5, -4.2) -- cycle;

\draw[red, <->] (0, 0.1)+(45:0.3) arc (45:135:0.3);
\draw[red, <->] (4, 0.1)+(45:0.3) arc (45:135:0.3);
...
\textbf{Aufgabe} Investigate how the \color{blue}movement \color{black} of the springs depends on \color{orange}relevant parameters\color{black}.
\end{frame}
...
\draw[blue, thick] (0.25, -3.5) -- ++(-1.5, 0) -- ++(0, 1.25);
\draw[fill=red!30!white] (0.25, 0.25) circle[radius=0.25];
\draw[decorate, decoration={coildown,   aspect=0.1, amplitude=4 mm,  segment length=2mm}, blue, thick] (0.25,-0.75) -- (0.25, -3.5);
\draw[fill=gray!60!white] (0, 0) -- (0.5, 0) -- (0.5, -4) -- (0, -4) -- cycle;
\draw [decorate, decoration={coilup,   aspect=0.1, amplitude=4 mm,  segment length=2mm}, blue, thick] (0.25, -0.75) -- (0.25, -3.5);
\draw[red, <->] (0.75, -0.25) -- (0.75, 0.75);
\draw[blue, thick] (0.25, -0.75) -- ++(-1.5, 0) -- ++(0, -1.25);
\draw[blue, fill=white] (0.25, -0.75)+(-1.5, -1.25) circle[radius=0.05];
\draw[blue, fill=white] (0.25, -3.5)+(-1.5, 1.25) circle[radius=0.05];

\node at (-1.6, -2.1) {\large $\sim$};
\end{tikzpicture}
\end{center}
\par
\vfill
